...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const timeLinePictorialBarCharts = ref()
    ...
    onMounted(() => {
      ...
      //   // console.log(timeLinePictorialBarCharts.value)
      //   timeLinePictorialBarCharts.value.resize()
      // }

      const windowOnresizeEvent = () => {
        if (timeLinePictorialBarCharts.value)
          timeLinePictorialBarCharts.value.resize()
      }
    ...
    onBeforeUnmount(() => {
      ...
      timeLinePictorialBarCharts.value.dispose()
      timeLinePictorialBarCharts.value = null
    })

    // 方法 methods

    const initChart = () => {
      timeLinePictorialBarCharts.value = markRaw(
    ...
    const setOptions = () => {
      ...
      timeLinePictorialBarCharts.value.setOption(option)
    }
...
<template>
  <div
    class="timeLinePictorialBarCharts"
    ref="chart"
